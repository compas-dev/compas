...
Special planes can be constructed using predefined constructor methods.
...
Planes can also be constructed from other inputs than point and normal.
...
For distance calculations and membership verifications involving planes, see [Distance and Membership](basics.geometry.distance_and_membership.md).
For intersections between planes and other objects, see [Intersections](basics.geometry.intersections.md).
...
The first input vector is the X-axis of the coordinate system.
...
For more information on transformations and their relationship to frames, see [Transformations](basics.geometry.transformations.md).
