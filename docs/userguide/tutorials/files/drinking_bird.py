...
foot_1 = Box(Frame([2, 0.5, 0.25], [1, 0, 0], [0, 1, 0]), 1, 2, 0.5)
foot_2 = Box(Frame([-2, 0.5, 0.25], [1, 0, 0], [0, 1, 0]), 1, 2, 0.5)
leg_1 = Box(Frame([2, 0, 4], [1, 0, 0], [0, 1, 0]), 0.5, 1, 7)
leg_2 = Box(Frame([-2, 0, 4], [1, 0, 0], [0, 1, 0]), 0.5, 1, 7)
axis = Cylinder(Circle(Plane([0, 0, 7], [1, 0, 0]), 0.01), 4)
legs_link = model.add_link("legs", visual_meshes=[foot_1, foot_2, leg_1, leg_2, axis])

torso = Cylinder(Circle(Plane([0, 0, 0], [0, 0, 1]), 0.5), 8)
...
artist = SceneObject(model, layer="COMPAS::Example Robot")
artist.clear_layer()
artist.draw_visual()
