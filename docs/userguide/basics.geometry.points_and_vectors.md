...
A [`Point`][compas.geometry.Point] represents a location in 3D space.
...
See [Distance and Membership](basics.geometry.distance_and_membership.md) for more information.

## Vectors

A [`Vector`][compas.geometry.Vector] represents a direction in 3D space
...
[`Point`][compas.geometry.Point] and [`Vector`][compas.geometry.Vector] objects support basic arithmetic
