...
!!! note
    ...
    See [Visualisation](basics.visualisation.md) for more information on how to set it up and use it.

    Alternatively, you can run the examples in Rhino or Blender.
    See [Rhino](cad.rhino.md) and [Blender](cad.blender.md) for more information on how to get started with that.
