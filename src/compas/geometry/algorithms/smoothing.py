...
def smooth_centroid(vertices,
                    ...
                    callback=None,
                    callback_args=None):
    """Smooth a connected set of points, by moving each point to the centroid of its neighbours.
...
if __name__ == "__main__":
    ...
    vertices = smooth_centroid(vertices, adjacency, fixed=fixed, kmax=100, callback=callback)
