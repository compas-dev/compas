...
if __name__ == "__main__":
    ...
    __global__ void doublify(float *c, float *a)
    {
        int i = threadIdx.x;
        int j = threadIdx.y;
    ...
    func(cuda.Out(c), cuda.In(a), block=(2, 2, 1))
    ...
    __global__ void multiply(float *c, float *a, float *b)
    {
    ...
    b = array([2, 3, 4], dtype=float32)
    c = empty_like(a)

    func(cuda.Out(c), cuda.In(a), cuda.In(b), block=(3, 1, 1))
