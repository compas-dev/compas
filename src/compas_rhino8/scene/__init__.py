"""
This package provides scene object plugins for visualising COMPAS objects in Rhino 8.
When working in Rhino 8,
:class:`compas.scene.SceneObject` will automatically use the corresponding Rhino scene object for each COMPAS object type.
"""
...
def clear_rhino8(guids=None):
    compas_rhino8.clear(guids=guids)


@plugin(category="drawing-utils", pluggable_name="redraw", requires=["Rhino"])
def redraw_rhino8():
    compas_rhino8.redraw()
...
def register_scene_objects():
    ...
    print("Rhino8 SceneObjects registered.")
