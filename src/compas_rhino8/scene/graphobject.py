...
class GraphObject(RhinoSceneObject, BaseGraphObject):
    ...
    **kwargs : dict, optional
    ...
    def clear(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.*".format(self.graph.name))  # type: ignore
    ...
    def clear_nodes(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.node.*".format(self.graph.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_edges(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.edge.*".format(self.graph.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
