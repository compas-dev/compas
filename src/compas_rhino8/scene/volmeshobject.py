...
from compas_rhino8.conversions import point_to_rhino
from compas_rhino8.conversions import line_to_rhino
from compas_rhino8.conversions import vertices_and_faces_to_rhino
...
class VolMeshObject(RhinoSceneObject, BaseVolMeshObject):
    ...
    **kwargs : dict, optional
    ...
    def clear(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.*".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_vertices(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.vertex.*".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_edges(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.edge.*".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_faces(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.face.*".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_cells(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.cell.*".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_vertexlabels(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.vertex.*.label".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_edgelabels(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.edge.*.label".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def clear_facelabels(self):
        ...
        """
        guids = compas_rhino8.objects.get_objects(name="{}.face.*.label".format(self.volmesh.name))  # type: ignore
        compas_rhino8.objects.delete_objects(guids, purge=True)
    ...
    def draw_celllabels(self, text, color=None, group=None, fontheight=10, fontface="Arial Regular"):
        ...
        for cell in text:
            ...
            dot = Rhino.Geometry.TextDot(str(text[cell]), point)  # type: ignore
            dot.FontHeight = fontheight
            dot.FontFace = fontface
