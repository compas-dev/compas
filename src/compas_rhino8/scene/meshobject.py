...
from compas_rhino8.objects import get_objects, delete_objects
from compas_rhino8.conversions import vertices_and_faces_to_rhino
from compas_rhino8.conversions import mesh_to_rhino
from compas_rhino8.conversions import point_to_rhino
from compas_rhino8.conversions import line_to_rhino
from compas_rhino8.conversions import cylinder_to_rhino_brep
from compas_rhino8.conversions import sphere_to_rhino
...
class MeshObject(RhinoSceneObject, BaseMeshObject):
    ...
    **kwargs : dict, optional
    ...
    def clear(self):
        ...
        """
        guids = get_objects(name="{}.*".format(self.mesh.name))  # type: ignore
    ...
    def clear_vertices(self):
        ...
        """
        guids = get_objects(name="{}.vertex.*".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_edges(self):
        ...
        """
        guids = get_objects(name="{}.edge.*".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_faces(self):
        ...
        """
        guids = get_objects(name="{}.face.*".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_vertexnormals(self):
        ...
        """
        guids = get_objects(name="{}.vertex.*.normal".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_facenormals(self):
        ...
        """
        guids = get_objects(name="{}.face.*.normal".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_vertexlabels(self):
        ...
        """
        guids = get_objects(name="{}.vertex.*.label".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_edgelabels(self):
        ...
        """
        guids = get_objects(name="{}.edge.*.label".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
    ...
    def clear_facelabels(self):
        ...
        """
        guids = get_objects(name="{}.face.*.label".format(self.mesh.name))  # type: ignore
        delete_objects(guids, purge=True)
