...
from compas.data.validators import is_sequence_of_uint
from compas.data.validators import is_sequence_of_float

from compas.data.validators import is_int3
from compas.data.validators import is_float3
from compas.data.validators import is_float4x4
