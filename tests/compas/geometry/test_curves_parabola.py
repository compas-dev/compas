...
def test_parabola_create():
    ...
    assert TOL.is_allclose(parabola.point_at(0.0), parabola.point_at(0.0, world=False), tol=1e-12)
    assert TOL.is_allclose(parabola.point_at(0.5), parabola.point_at(0.5, world=False), tol=1e-12)
    assert TOL.is_allclose(parabola.point_at(1.0), parabola.point_at(1.0, world=False), tol=1e-12)
...
def test_parabola_create_with_frame():
    ...
    assert TOL.is_allclose(parabola.point_at(0.0), parabola.point_at(0.0, world=False), tol=1e-12)
    assert not TOL.is_allclose(parabola.point_at(0.5), parabola.point_at(0.5, world=False), tol=1e-12)
    assert not TOL.is_allclose(parabola.point_at(1.0), parabola.point_at(1.0, world=False), tol=1e-12)
...
def test_parabola_data():
    ...
    assert TOL.is_allclose(parabola.frame.xaxis, other.frame.xaxis, tol=1e-12)
    assert TOL.is_allclose(parabola.frame.yaxis, other.frame.yaxis, tol=1e-12)
